...
function Courses() {
  return (
    <motion.div className='parent mt'>
     <div className="text container container_child">
     <h1>Our Approach</h1>
     <p>We are dedicated to offering students the chance to learn Arabic and the Quran conveniently from the comfort of their homes, facilitated by our expert online Quran and Arabic teachers. Enrolling in our courses ensures that the process of reading the Quran online becomes effortlessly accessible for you.</p>
     </div>
<motion.div className="section_our_solution mt"
        ...
        <div className="solution_cards_box">
          <div className="solution_card">
            ...
            <div className="so_top_icon">
              <svg id="Layer_1"   height="50" viewBox="0 0 512 512" width="40" xmlns="http://www.w3.org/2000/svg">
                <g>
                  <g>
                    <g>
                      <g>
            ...
            <div className="solu_description">
              ...
              <Link to='/demo'><button type="button" className="read_more_btn">Read More</button></Link>
            </div>
          </div>
          <div className="solution_card">
            <div className="hover_color_bubble"></div>
